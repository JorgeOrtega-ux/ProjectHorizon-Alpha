...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($action_type) {
        ...
        case 'register_user_step2':
            ...
            // Eliminar códigos de registro previos para el mismo email
        ...
        case 'verify_registration_code':
            ...
            if ($stmt_check->num_rows > 0) {
                ...
                try {
                    ...
                    $stmt_insert_user = $conn->prepare("INSERT INTO users (uuid, username, email, password_hash) VALUES (?, ?, ?, ?)");
                    $stmt_insert_user->bind_param("ssss", $uuid, $username, $email, $password_hash);
        ...
        case 'forgot_password':
            ...
            if ($stmt->num_rows > 0) {
                // ✅ **INICIO DE LA CORRECCIÓN**
                // Eliminar códigos de restablecimiento previos para el mismo email
