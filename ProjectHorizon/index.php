                ...
                <div class="general-content-bottom">
                    ...
                    <div class="general-content-scrolleable">
                        <div class="section-container <?php echo ($CURRENT_VIEW === 'main') ? 'active' : 'disabled'; ?>" data-view="main">
                            ...
                            <div class="section-content <?php echo ($CURRENT_SECTION === '404') ? 'active' : 'disabled'; ?>" data-section="404"><h1>404 - Not Found</h1><p>The page you are looking for does not exist.</p></div>
                        </div>
