<div class="section-content <?php echo ($CURRENT_SECTION === 'register') ? 'active' : 'disabled'; ?>" data-section="register">
    <div class="auth-container">
        <div class="auth-wrapper">
            <h1 class="auth-title">Crear Cuenta de Administrador</h1>
            <form id="register-form" class="auth-form" method="post">
                ...
                <div class="auth-input-wrapper">
                    <input class="auth-input" type="text" id="admin-code-input" name="admin-code" inputmode="numeric" maxlength="9" required placeholder=" ">
                    <label class="auth-label" for="admin-code-input">Código de Administrador*</label>
                </div>
